...
This version includes in addition to the full working PATS application an administration dashboard created using [ActiveAdmin](https://activeadmin.info/index.html) and [Chartkick](https://chartkick.com/#rails-5-sprockets)
